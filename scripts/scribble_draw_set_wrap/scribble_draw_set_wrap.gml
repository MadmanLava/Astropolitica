...
/// 
/// @param minLineHeight     Minimum line height for each line of text. Use a negative number (the default) for the height of a space character of the default font
/// @param maxLineWidth      Maximum line width for each line of text. Use a negative number (the default) for no limit
/// @param [maxLineHeight]   Maximum height for the whole textbox. Use a negative number (the default) for no limit
